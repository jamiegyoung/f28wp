...
const InstructionsPage = () => {
  ...
  return (
    <div className={`instructions-container ${pseudoHidden ? "hidden" : ""}`}>
      ...
      <p>
        To play the game, you need to register an account{" "}
        <Link
          style={{
            color: "teal",
            marginTop: "50px",
...
'--[     ]--'
   ...
   |__|__|`}</pre>
      ...
      <p>
        ...
        mistake, holding BACKSPACE on your keyboard will entire word in the
        combat bar.
      </p>
      <p>
        ...
        successfully until they have no Hit Points left, so you may move on to
        the next. Beware though! You only have 20 seconds to kill a boss.
      </p>
      <p>
        ...
        level 100 and kill the final boss to be the victor.
      </p>
      <p>
      ...
      <p>
        Worry not, though! You have friends that will help you along the way ;).
      </p>
